...
# Adjust the sys.path if needed (usually in contest.py or at the top of your test files)

def test_get_trip_duration_mins(spark):
    """
    Práctiamente usamos esta función para calcular la diferencia entre
    2 fechas conocidas y ver que la función get_trip_duration_mins nos 
    devuelve la diferencia en minutos correcta.
    """
